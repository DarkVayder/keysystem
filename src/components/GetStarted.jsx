...
const GetStarted = () => {
  return (
    <div className="bg-gradient-to-r from-[#0B2D92] to-[#030517] py-16 px-6 text-white">
      <div className="bg-gradient-to-r from-[#030517] to-[#181B4D] p-8 rounded-xl shadow-xl flex flex-col md:flex-row items-center md:justify-between transition-shadow duration-500 ease-in-out hover:shadow-[0_0_40px_rgba(65,105,225,0.6)] max-w-4xl mx-auto">
        {/* Text Section */}
